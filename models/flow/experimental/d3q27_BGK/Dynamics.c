...
/*
        ...
        References:
        [1]    Bhatnagar, P.L., Gross, E.P., Krook, M., 1954. A model for collision processes in gases. I. small amplitude processes in charged and neutral
one-component systems. Phys. Rev. 94, 511-525. URL http://	link.aps.org/doi/10.1103/PhysRev.94.511.
...
CudaDeviceFunction void CollisionMRT() {
    ...
    f112 = (1. - omega)*f112 +
           omega*((rho + (-Jz + Jy + Jx + (Jz*Jz + Jy*Jy + Jx*Jx + (-Jz*Jy + (-Jz + Jy)*Jx)*3.)/rho)*3.)*0.00462962962962963);
    f212 = (1. - omega)*f212 +
           omega*((rho + (-Jz + Jy - Jx + (Jz*Jz + Jy*Jy + Jx*Jx + (-Jz*Jy + (Jz - Jy)*Jx)*3.)/rho)*3.)*0.00462962962962963);
    f121 = (1. - omega)*f121 +
           omega*((rho + (Jz - Jy + Jx + (Jz*Jz + Jy*Jy + Jx*Jx + (-Jz*Jy + (Jz - Jy)*Jx)*3.)/rho)*3.)*0.00462962962962963);
