...
/*
        ...
        W. Regulski, C. Leonardi, J. Szumbarski, On the spatial convergence and transient behavior of lattice Boltzmann methods for modeling fluids with yield
stress
...
CudaDeviceFunction real_t getRho() {
    return f222 + f122 + f022 + f212 + f112 + f012 + f202 + f102 + f002 + f221 + f121 + f021 + f211 + f111 + f011 + f201 + f101 + f001 + f220 + f120 + f020 +
           f210 + f110 + f010 + f200 + f100 + f000;
}
...
CudaDeviceFunction void CollisionMRT() {
    real_t Rho = f222 + f122 + f022 + f212 + f112 + f012 + f202 + f102 + f002 + f221 + f121 + f021 + f211 + f111 + f011 + f201 + f101 + f001 + f220 + f120 +
                 f020 + f210 + f110 + f010 + f200 + f100 + f000;
    real_t RhoInv = 1./Rho;
    ...
    real_t Ux =
        (-f222 + f122 - f212 + f112 - f202 + f102 - f221 + f121 - f211 + f111 - f201 + f101 - f220 + f120 - f210 + f110 - f200 + f100)*RhoInv + ForceX*0.5;
    real_t Uy =
        (-f222 - f122 - f022 + f212 + f112 + f012 - f221 - f121 - f021 + f211 + f111 + f011 - f220 - f120 - f020 + f210 + f110 + f010)*RhoInv + ForceY*0.5;
    real_t Uz =
        (-f222 - f122 - f022 - f212 - f112 - f012 - f202 - f102 - f002 + f221 + f121 + f021 + f211 + f111 + f011 + f201 + f101 + f001)*RhoInv + ForceZ*0.5;
    real_t Usq = Ux*Ux + Uy*Uy + Uz*Uz;

    /* partial Rho - stores consecutive fractions of density */
    real_t rho_par = Rho*2./9.;
    Phi000 = 0.0;
    Phi100 = rho_par*(ForceX);
    Phi010 = rho_par*(+ForceY);
    Phi200 = rho_par*(-ForceX);
    Phi020 = rho_par*(-ForceY);
    Phi001 = rho_par*(+ForceZ);
    Phi002 = rho_par*(-ForceZ);
    rho_par *= 0.25;
    Phi110 = rho_par*(ForceX + ForceY);
    Phi210 = rho_par*(-ForceX + ForceY);
    Phi220 = rho_par*(-ForceX - ForceY);
    Phi120 = rho_par*(ForceX - ForceY);
    Phi101 = rho_par*(ForceX + ForceZ);
    Phi011 = rho_par*(+ForceY + ForceZ);
    Phi201 = rho_par*(-ForceX + ForceZ);
    Phi021 = rho_par*(-ForceY + ForceZ);
    Phi102 = rho_par*(ForceX - ForceZ);
    Phi012 = rho_par*(+ForceY - ForceZ);
    Phi202 = rho_par*(-ForceX - ForceZ);
    Phi022 = rho_par*(-ForceY - ForceZ);
    rho_par *= 0.25;
    Phi111 = rho_par*(ForceX + ForceY + ForceZ);
    Phi211 = rho_par*(-ForceX + ForceY + ForceZ);
    Phi221 = rho_par*(-ForceX - ForceY + ForceZ);
    Phi121 = rho_par*(ForceX - ForceY + ForceZ);
    Phi112 = rho_par*(ForceX + ForceY - ForceZ);
    Phi212 = rho_par*(-ForceX + ForceY - ForceZ);
    Phi222 = rho_par*(-ForceX - ForceY - ForceZ);
    Phi122 = rho_par*(ForceX - ForceY - ForceZ);
    ...
    rho_par *= 0.25;
    f_eq100 = rho_par*(1. + 3.*Ux*(1 + 1.5*(+Ux)) - 1.5*Usq) - 0.5*Phi100;
    f_eq010 = rho_par*(1. + 3.*Uy*(1 + 1.5*(+Uy)) - 1.5*Usq) - 0.5*Phi010;
    f_eq200 = rho_par*(1. - 3.*Ux*(1 + 1.5*(-Ux)) - 1.5*Usq) - 0.5*Phi200;
    f_eq020 = rho_par*(1. - 3.*Uy*(1 + 1.5*(-Uy)) - 1.5*Usq) - 0.5*Phi020;
    f_eq001 = rho_par*(1. + 3.*Uz*(1 + 1.5*(+Uz)) - 1.5*Usq) - 0.5*Phi001;
    f_eq002 = rho_par*(1. - 3.*Uz*(1 + 1.5*(-Uz)) - 1.5*Usq) - 0.5*Phi002;
    rho_par *= 0.25;
    f_eq110 = rho_par*(1. + 3.*(Ux + Uy)*(1 + 1.5*(+Ux + Uy)) - 1.5*Usq) - 0.5*Phi110;
    f_eq210 = rho_par*(1. + 3.*(-Ux + Uy)*(1 + 1.5*(-Ux + Uy)) - 1.5*Usq) - 0.5*Phi210;
    f_eq220 = rho_par*(1. + 3.*(-Ux - Uy)*(1 + 1.5*(-Ux - Uy)) - 1.5*Usq) - 0.5*Phi220;
    f_eq120 = rho_par*(1. + 3.*(Ux - Uy)*(1 + 1.5*(+Ux - Uy)) - 1.5*Usq) - 0.5*Phi120;
    f_eq101 = rho_par*(1. + 3.*(Ux + Uz)*(1 + 1.5*(+Ux + Uz)) - 1.5*Usq) - 0.5*Phi101;
    f_eq011 = rho_par*(1. + 3.*(Uy + Uz)*(1 + 1.5*(+Uy + Uz)) - 1.5*Usq) - 0.5*Phi011;
    f_eq201 = rho_par*(1. + 3.*(-Ux + Uz)*(1 + 1.5*(-Ux + Uz)) - 1.5*Usq) - 0.5*Phi201;
    f_eq021 = rho_par*(1. + 3.*(-Uy + Uz)*(1 + 1.5*(-Uy + Uz)) - 1.5*Usq) - 0.5*Phi021;
    f_eq102 = rho_par*(1. + 3.*(Ux - Uz)*(1 + 1.5*(+Ux - Uz)) - 1.5*Usq) - 0.5*Phi102;
    f_eq012 = rho_par*(1. + 3.*(Uy - Uz)*(1 + 1.5*(+Uy - Uz)) - 1.5*Usq) - 0.5*Phi012;
    f_eq202 = rho_par*(1. + 3.*(-Ux - Uz)*(1 + 1.5*(-Ux - Uz)) - 1.5*Usq) - 0.5*Phi202;
    f_eq022 = rho_par*(1. + 3.*(-Uy - Uz)*(1 + 1.5*(-Uy - Uz)) - 1.5*Usq) - 0.5*Phi022;
    rho_par *= 0.25;
    ...
    Sxx -= +f_eq100 + f_eq200 + f_eq110 + f_eq210 + f_eq220 + f_eq120 + f_eq101 + f_eq201 + f_eq102 + f_eq202 + f_eq111 + f_eq211 + f_eq221 + f_eq121 +
           f_eq112 + f_eq212 + f_eq222 + f_eq122;
    ...
    Syy -= +f_eq010 + f_eq020 + f_eq110 + f_eq210 + f_eq220 + f_eq120 + f_eq011 + f_eq021 + f_eq012 + f_eq022 + f_eq111 + f_eq211 + f_eq221 + f_eq121 +
           f_eq112 + f_eq212 + f_eq222 + f_eq122;
    Syz -= +f_eq011 - f_eq021 - f_eq012 + f_eq022 + f_eq111 + f_eq211 - f_eq221 - f_eq121 - f_eq112 - f_eq212 + f_eq222 + f_eq122;
    Szz -= +f_eq001 + f_eq002 + f_eq101 + f_eq011 + f_eq201 + f_eq021 + f_eq102 + f_eq012 + f_eq202 + f_eq022 + f_eq111 + f_eq211 + f_eq221 + f_eq121 +
           f_eq112 + f_eq212 + f_eq222 + f_eq122;
    ...
    f000 = f_eq000 + Phi000;
    f200 = 1./3.*(Sxx) + f_eq200 + Phi200;
    f100 = 1./3.*(Sxx) + f_eq100 + Phi100;
    f020 = 1./3.*(+Syy) + f_eq020 + Phi020;
    f010 = 1./3.*(+Syy) + f_eq010 + Phi010;
    f002 = 1./3.*(+Szz) + f_eq002 + Phi002;
    f001 = 1./3.*(+Szz) + f_eq001 + Phi001;

    f220 = 1./12.*(Sxx + 2*Sxy + Syy) + f_eq220 + Phi220;
    f110 = 1./12.*(Sxx + 2*Sxy + Syy) + f_eq110 + Phi110;
    f120 = 1./12.*(Sxx - 2*Sxy + Syy) + f_eq120 + Phi120;
    f210 = 1./12.*(Sxx - 2*Sxy + Syy) + f_eq210 + Phi210;
    f202 = 1./12.*(Sxx + 2*Sxz + Szz) + f_eq202 + Phi202;
    f101 = 1./12.*(Sxx + 2*Sxz + Szz) + f_eq101 + Phi101;
    f022 = 1./12.*(+Syy + 2*Syz + Szz) + f_eq022 + Phi022;
    f011 = 1./12.*(+Syy + 2*Syz + Szz) + f_eq011 + Phi011;
    f102 = 1./12.*(Sxx - 2*Sxz + Szz) + f_eq102 + Phi102;
    f201 = 1./12.*(Sxx - 2*Sxz + Szz) + f_eq201 + Phi201;
    f012 = 1./12.*(+Syy - 2*Syz + Szz) + f_eq012 + Phi012;
    f021 = 1./12.*(+Syy - 2*Syz + Szz) + f_eq021 + Phi021;

    f222 = 1./48.*(Sxx + 2*Sxy + 2*Sxz + Syy + 2*Syz + Szz) + f_eq222 + Phi222;
    f111 = 1./48.*(Sxx + 2*Sxy + 2*Sxz + Syy + 2*Syz + Szz) + f_eq111 + Phi111;
    f122 = 1./48.*(Sxx - 2*Sxy - 2*Sxz + Syy + 2*Syz + Szz) + f_eq122 + Phi122;
    f211 = 1./48.*(Sxx - 2*Sxy - 2*Sxz + Syy + 2*Syz + Szz) + f_eq211 + Phi211;
    f112 = 1./48.*(Sxx + 2*Sxy - 2*Sxz + Syy - 2*Syz + Szz) + f_eq112 + Phi112;
    f221 = 1./48.*(Sxx + 2*Sxy - 2*Sxz + Syy - 2*Syz + Szz) + f_eq221 + Phi221;
    f212 = 1./48.*(Sxx - 2*Sxy + 2*Sxz + Syy - 2*Syz + Szz) + f_eq212 + Phi212;
    f121 = 1./48.*(Sxx - 2*Sxy + 2*Sxz + Syy - 2*Syz + Szz) + f_eq121 + Phi121;
