...
CudaDeviceFunction void Run() {
    ...
    if (NodeType & NODE_DESIGNSPACE) { AddToMaterialPenalty(w*(1 - w)); }
}
...
CudaDeviceFunction void SetEquilibrum(real_t rho, real_t Jx, real_t Jy, real_t Jz, real_t T) {
    ...
    f7 = 2.7777777778e-02*rho + 8.3333333333e-02*Jx + 8.3333333333e-02*(Jx*Jx) + 8.3333333333e-02*Jy + 2.5000000000e-01*Jx*Jy +
         8.3333333333e-02*(Jy*Jy) - 4.1666666667e-02*(Jz*Jz);
    f8 = 2.7777777778e-02*rho - 8.3333333333e-02*Jx + 8.3333333333e-02*(Jx*Jx) + 8.3333333333e-02*Jy - 2.5000000000e-01*Jx*Jy +
         8.3333333333e-02*(Jy*Jy) - 4.1666666667e-02*(Jz*Jz);
    f9 = 2.7777777778e-02*rho + 8.3333333333e-02*Jx + 8.3333333333e-02*(Jx*Jx) - 8.3333333333e-02*Jy - 2.5000000000e-01*Jx*Jy +
         8.3333333333e-02*(Jy*Jy) - 4.1666666667e-02*(Jz*Jz);
    f10 = 2.7777777778e-02*rho - 8.3333333333e-02*Jx + 8.3333333333e-02*(Jx*Jx) - 8.3333333333e-02*Jy + 2.5000000000e-01*Jx*Jy +
          8.3333333333e-02*(Jy*Jy) - 4.1666666667e-02*(Jz*Jz);
    f11 = 2.7777777778e-02*rho + 8.3333333333e-02*Jx + 8.3333333333e-02*(Jx*Jx) - 4.1666666667e-02*(Jy*Jy) + 8.3333333333e-02*Jz +
          2.5000000000e-01*Jx*Jz + 8.3333333333e-02*(Jz*Jz);
    f12 = 2.7777777778e-02*rho - 8.3333333333e-02*Jx + 8.3333333333e-02*(Jx*Jx) - 4.1666666667e-02*(Jy*Jy) + 8.3333333333e-02*Jz -
          2.5000000000e-01*Jx*Jz + 8.3333333333e-02*(Jz*Jz);
    f13 = 2.7777777778e-02*rho + 8.3333333333e-02*Jx + 8.3333333333e-02*(Jx*Jx) - 4.1666666667e-02*(Jy*Jy) - 8.3333333333e-02*Jz -
          2.5000000000e-01*Jx*Jz + 8.3333333333e-02*(Jz*Jz);
    f14 = 2.7777777778e-02*rho - 8.3333333333e-02*Jx + 8.3333333333e-02*(Jx*Jx) - 4.1666666667e-02*(Jy*Jy) - 8.3333333333e-02*Jz +
          2.5000000000e-01*Jx*Jz + 8.3333333333e-02*(Jz*Jz);
    f15 = 2.7777777778e-02*rho - 4.1666666667e-02*(Jx*Jx) + 8.3333333333e-02*Jy + 8.3333333333e-02*(Jy*Jy) + 8.3333333333e-02*Jz +
          2.5000000000e-01*Jy*Jz + 8.3333333333e-02*(Jz*Jz);
    f16 = 2.7777777778e-02*rho - 4.1666666667e-02*(Jx*Jx) - 8.3333333333e-02*Jy + 8.3333333333e-02*(Jy*Jy) + 8.3333333333e-02*Jz -
          2.5000000000e-01*Jy*Jz + 8.3333333333e-02*(Jz*Jz);
    f17 = 2.7777777778e-02*rho - 4.1666666667e-02*(Jx*Jx) + 8.3333333333e-02*Jy + 8.3333333333e-02*(Jy*Jy) - 8.3333333333e-02*Jz -
          2.5000000000e-01*Jy*Jz + 8.3333333333e-02*(Jz*Jz);
    f18 = 2.7777777778e-02*rho - 4.1666666667e-02*(Jx*Jx) - 8.3333333333e-02*Jy + 8.3333333333e-02*(Jy*Jy) - 8.3333333333e-02*Jz +
          2.5000000000e-01*Jy*Jz + 8.3333333333e-02*(Jz*Jz);
...
#define S19 1.0  // 98
    ...
    R0 = -30*f0 - 11*f1 - 11*f2 - 11*f3 - 11*f4 - 11*f5 - 11*f6 + 8*f7 + 8*f8 + 8*f9 + 8*f10 + 8*f11 + 8*f12 + 8*f13 + 8*f14 +
         8*f15 + 8*f16 + 8*f17 + 8*f18;
