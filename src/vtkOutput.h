...
public:
    ...
    inline void WriteField(const char* name, vector_t* data) {
        WriteField(name, (void*)data, sizeof(vector_t), "Float32", 3);
    };
#else
    inline void WriteField(const char* name, vector_t* data) {
        WriteField(name, (void*)data, sizeof(vector_t), "Float64", 3);
    };
#endif
    inline void WriteField(const char* name, int* data) {
        WriteField(name, (void*)data, sizeof(int), "Int32", 1);
    };
    inline void WriteField(const char* name, char* data) {
        WriteField(name, (void*)data, sizeof(char), "Int8", 1);
    };
    inline void WriteField(const char* name, unsigned char* data) {
        WriteField(name, (void*)data, sizeof(char), "UInt8", 1);
    };
    inline void WriteField(const char* name, short int* data) {
        WriteField(name, (void*)data, sizeof(short int), "Int16", 1);
    };
    inline void WriteField(const char* name, unsigned short int* data) {
        WriteField(name, (void*)data, sizeof(unsigned short int), "UInt16", 1);
    };
    inline void WriteField(const char* name, unsigned int* data) {
        WriteField(name, (void*)data, sizeof(unsigned int), "UInt32", 1);
    };
    void Finish();
    void Close();
};
