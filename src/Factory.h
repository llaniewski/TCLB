...
//   All the workers ...
template <class Product, class Input>
typename Factory<Product, Input>::Workers Factory<Product, Input>::Staff;
//   All the Dummies
template <class Product, class Input>
template <Product* (*T)(const Input&)>
typename Factory<Product, Input>::template Register<T>::Idiot Factory<Product, Input>::Register<T>::Dummy;
