...
/// \param self_edge_ind index of the offset direction (0,0,0). If (0,0,0) is not an offset direction, self_edge_ind should be set to any value outside the
/// interval [0, Q) \return distribution (in the ParMETIS sense) of nodes among the processes of comm
